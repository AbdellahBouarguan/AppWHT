...
public class SplashView {
    ...
    public SplashView(Runnable onComplete) {
        ...
        progressBar.setStyle(
                "-fx-accent: #0b846d; -fx-control-inner-background: #233138; -fx-background-color: #233138; -fx-background-radius: 5px;");
        ...
        content.getChildren().addAll(waIcon, title, progressBar, subtitle, encryptionBox);
