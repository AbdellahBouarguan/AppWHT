...
public class LoginView {
    ...
    private StackPane buildLogin() {
        ...
        Label ipLabel = new Label("Adresse IP du Serveur");
        ipLabel.setFont(Font.font("Arial", 12));
        ipLabel.setTextFill(Color.web("#d0eeff"));

        serverIpField = new TextField("127.0.0.1");
        serverIpField.setMaxWidth(320);
        serverIpField.setPrefHeight(48);
        serverIpField.setStyle(fieldStyle());
        ...
        card.getChildren().addAll(title, subtitle, userLabel, usernameField, passLabel, passwordField, ipLabel,
                serverIpField, errorLabel,
                loginBtn, signupLink);
    ...
    private StackPane buildRegister() {
        ...
        Label regIpLabel = new Label("Adresse IP du Serveur");
        regIpLabel.setFont(Font.font("Arial", 12));
        regIpLabel.setTextFill(Color.web("#d0eeff"));

        regServerIpField = new TextField("127.0.0.1");
        regServerIpField.setMaxWidth(320);
        regServerIpField.setPrefHeight(48);
        regServerIpField.setStyle(fieldStyle());
        ...
        card.getChildren().addAll(title, subtitle, usernameLabel, regUsernameField, phoneLabel, regPhoneField,
                passLabel, regPasswordField, regIpLabel, regServerIpField, regErrorLabel, registerBtn, loginLink);
